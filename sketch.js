...
function setup() {
  ...
  trex = createSprite(160,height/3,20,50);
  ...
  gameOver = createSprite(width/1.5,height/2);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(width/1.5+50,height/2+50);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width,height-120,40,10);
